package com.zhuhua.simulationlocation.db;
...
public class LocationSharePreference {
     ...
     * 保存在手机里面的文件名
     */
    public static final String FILE_NAME = "share_location_data";
    /**
    ...
    public static void putImage(Context mContext, String key, ImageView imageView) {
        ...
        // 将String保存shareUtils
        LocationSharePreference.put(mContext, key, imgString);
    }
    /**
    ...
    public static Bitmap getImage(Context mContext, String key, ImageView imageView) {
        String imgString = (String) LocationSharePreference.get(mContext, key, "");
        if (!imgString.equals("")) {
            // 利用Base64将我们string转换
